...
//?----------------------BENZIN ISTASYONU---------------------------------
// const altSatir = "\r\n";
// let Dizel = 3.49, Benzin=2.99, LPG=1.99;
// let yakitTuru = "1-Dizel: 3.49 $" + altSatir + "2-Benzin : 2.99 $" +altSatir+ "3-LPG: 1.99 $"+ altSatir +altSatir+altSatir +"Lutfen yakit turunuzu giriniz...";
...
//         if(bakiyeniz>=tutar){
//             alert("Isleminiz onaylandi" + altSatir + "**********************"+ altSatir+ "Islem tutariniz: "+ tutar + "Bakiyeniz: " + (bakiyeniz-tutar) + "$ dir")
//         }
//         else{
//             alert("Isleminiz basarisiz oldu. " + altSatir + "Bakiyeniz yetersiz." + altSatir + "Bakiye eksiginiz:" + (tutar-bakiyeniz)+ "$ dir.")
//         }
//      }
//      else if(secim==2){
//         let tutar = galon*Benzin;
//         if(bakiyeniz>=tutar){
//             alert("Isleminiz onaylandi" + altSatir+"**********************"+ altSatir+ "Islem tutariniz: "+ tutar + altSatir + "Bakiyeniz: " + (bakiyeniz-tutar) + "$ dir")
//         }
//         else{
//             alert("Isleminiz basarisiz oldu. " + altSatir + "Bakiyeniz yetersiz." + altSatir + "Bakiye eksiginiz:" + (tutar-bakiyeniz)+ "$ dir.")
//         }
...
// let metin = "1-Bakiye goruntuleme" + altSatir + "2-Para cekme" + altSatir +
// "3-Para yatirma" + altSatir+"4-Cikis" +altSatir+ altSatir+"Lutfen bir islem seciniz...";
...
//  let emeklilik = (65-yas>0) ? "Emeklilige " + (65-yas) + " yil kaldi." : "Zaten emeklisiniz.";
...
// let kursAdi = "Komple Uygulamali Web Gelistirme Kursu"

// //?url karakter sayisi?
// let result1 = url.length;
// console.log(result1);

// //?kurs adi kac kelimeden olusur?
// let result2 = kursAdi.split(" ");
// console.log(result2.length);

// //?url https ile mi basliyor??
// let result3 = url.startsWith("https");
// console.log(result3);
...
// let sayi = 15.154454;
// let sonuc = sayi.toPrecision(5) // sayinin 5 basamagini al
// console.log(sonuc)
...
// console.log("1 numarali ogrencimiz " , ogrenci1[0] , ' not ortalamasi: ' , (ogrenci1[2][0]+ogrenci1[2][1]+ogrenci1[2][2])/3 , " yasida: " , 2025-ogrenci1[1])
...
// let toplam1 =  siparisler[0].alinanUrunler[0].urunFiyati*(0.18+1) + siparisler[0].alinanUrunler[1].urunFiyati*(1+0.18);
...
// let toplam1 = 0;
// for(let index in sayilar){//sayilarin index numarasini index`e atar
//     toplam1 += sayilar[index]
// }
// console.log(toplam1)

// for(let sayi of sayilar){//buradada sayilarin degerlerini sayiya atar
//     console.log(sayi)
// }
...
//     "email":"info@nino.com"
// }
// for(let key in user){//obje ile kullanimi
